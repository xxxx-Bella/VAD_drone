...
```shell
# pip install -r ./work/pred_CVPR2018/Codes/requirements.txt
...
avenue___l2_alpha1_lp0.001_: train.py (withOut change line200)
avenue__l2_alpha1_lp0.001_: train.py (with change line200)
...
* Ignore '--- No checkpoint file found.'
```shell
python train.py  --dataset  ped2    \
                 --train_folder  ../Data/Data/ped2/training/frames     \
                 --test_folder  ../Data/Data/ped2/testing/frames       \
                 --gpu  0       \
                 --iters    1000

python train.py  --dataset  ped2    \
                 --train_folder  ../Data/Data/Bike_Roundabout/sequence1/train     \
                 --test_folder  ../Data/Data/Bike_Roundabout/sequence1/test      \
                 --gpu  0       \
                 --iters    1000
