...
```shell
python train.py  --dataset  Campus    \
                 --train_folder  ../Data/Data/Campus/playground_compact/train     \
                 --test_folder  ../Data/Data/Campus/playground_compact/test      \
                 --gpu  0       \
                 --iters    1000
...
python inference.py  --dataset  Campus    \
                    --test_folder  ../Data/Data/Campus/playground_compact/test      \
                    --gpu  1     \
                    --evaluate compute_auc
                    
python inference.py  --dataset  Campus_Drone    \
                    --test_folder  ../Data/Data/Campus_Drone/playground_drone_compact/test      \
                    --gpu  1     \
                    --evaluate compute_auc
